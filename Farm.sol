...
abstract contract DelegateERC20 is ERC20 {
    ...
    */
    ...
    internal
    {
        uint32 blockNumber = safe32(block.number, "CMPToken::_writeCheckpoint: block number exceeds 32 bits");
...
contract Farm is Ownable, ReentrancyGuard {
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint; // How many allocation points assigned to this pool. CMP to distribute per block.
